...
/// The class to manage the logs. You can provide your own logger implementing the `Logger` protocol.
public class OCastLogger {
    
    /// The singleton instance.
    public static let shared = OCastLogger()
